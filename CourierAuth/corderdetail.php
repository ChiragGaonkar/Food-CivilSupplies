...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top" style="padding: 10px 30px 10px 30px">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav" style="margin-left: auto;">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" style="margin-right: 20px;" aria-current="page"
                            href="corderhistory.php">History</a>
                    </li>
    ...
    <span class="detailcard">
    <div class="card mb-3"  >
  <div class="row g-0" style="background-color: cyan">
    <div class="col-md-4">
      <img src="ccard.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8" >
      <div class="card-body">
        <h4 class="card-title"style="text-align:center;">WHEAT</h4>
        <p class="card-text">
            ...
            <p style="text-align:right;"><button>Deliver</button><p>
        </p>
        <p class="card-text"><small class="text-muted">Food & Civil Supplies</small></p>
      </div>
    </div>
  </div>
</div>
