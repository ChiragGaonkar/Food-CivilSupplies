...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE `product_data` SET PID=$pid, PNAME='$pname', QUANTITY=$quantity, PRICE=$price, MANU_DATE='$md', EXP_DATE='$ed' where Pid=$pid";
...
<body>
    ...
    <div class="container">
        ...
        <div>
            <br>
            <h1 class="text-center" style="color: white;">UPDATE RATION</h1><br>
        </div>
            ...
            <form method="post" name="myform" onsubmit="return validate()" enctype="multipart/form-data"
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="0" placeholder="Product Id" name="pid" autocomplete="off" required
                        class="form-control" value=<?php echo $pid ?>>
                    <br><br>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" placeholder="Manufacturing Date" name="date1" autocomplete="off" required
                        class="form-control" value=<?php echo $md ?>>
                    <br><br>
                </div>
                <div class="form-group">
                    ...
                    <input type="date" placeholder="Expiry Date" name="date2" autocomplete="off" required
                        class="form-control" value=<?php echo $ed ?>><br>
                ...
                <div class="m-auto">
                    <button type="reset" name="Reset" value="Reset" class="btn btn-primary float-start"
                        style="background-color:brown; border:brown"><a href="dis.php">Cancel</a></button>
                    <button type="submit" name="submit" value="Submit" class="btn btn-primary float-end"
                        style="background-color:brown;"><a href="dis.php">Submit</a></button>
                </div>
