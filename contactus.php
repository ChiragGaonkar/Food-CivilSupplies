...
if (isset($_SESSION['UAADHAR'])) {
    if (isset($_POST['send_msg'])) {
        $message_body = mysqli_escape_string($connection, $_POST['msgbody']);
        sendUserOtp($email, 0000, "Admin", $district, $message_body);
    }
}
?>
...
<body>
    <!-- <li class="nav-item">
        <a class="nav-link" style="margin-right: 10px;" data-bs-toggle="modal" data-bs-target="#exampleModal">Contact
            Us</a>
    </li> -->
