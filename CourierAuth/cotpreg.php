...
$cdistrict = $_SESSION['cdistrict'];
$caadharnum = $_SESSION['caadharnum'];
$otp = $_SESSION['otp'];
...
if (isset($_POST['creg_otp'])) {
    if ($otp == $cotp) {
        $sql = "INSERT INTO courier_data (CID,CFNAME,CLNAME,CEMAIL,CPASSWORD,CDISTRICT,CAADHARNUM) 
                VALUES ($cid,'$cfname','$clname','$cemail','$cpassword','$cdistrict',$caadharnum)";
