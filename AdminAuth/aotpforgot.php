...
// Updating Password
if (isset($_POST['aforgot_otp'])) {
    $otp = $_SESSION['fotp'];
    $aid = $_SESSION['faid'];
    $aEmail = $_SESSION['faEmail'];
    $newPassword = $_SESSION['fnewPassword'];

    $aotp = mysqli_escape_string($connection, $_POST['AOTP']);

    if ($aotp == $otp) {
        $sql = "UPDATE admin_data SET APASSWORD = '$newPassword' WHERE AEMAIL = '$aEmail' AND AID = $aid";
        ...
        <div class="row justify-content-center align-items-center">
            ...
            <form name="myform" action="" method="POST" class="col-md-4 myform" style="margin: 30px 0px 0px 0px;">
                ...
                <div class="d-grid gap-2 inputs">
                    <input class="btn btn-success" type="submit" name="aforgot_otp" value="Change My Password"
