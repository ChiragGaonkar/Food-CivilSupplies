...
// Updating Password
if (isset($_POST['cforgot_otp'])) {
    $otp = $_SESSION['fotp'];
    $cid = $_SESSION['fcid'];
    $cEmail = $_SESSION['fcEmail'];
    $newPassword = $_SESSION['fnewPassword'];

    $cotp = mysqli_escape_string($connection, $_POST['COTP']);

    if ($cotp == $otp) {
        $sql = "UPDATE courier_data SET CPASSWORD = '$newPassword' WHERE CEMAIL = '$cEmail' AND CID = $cid";
        ...
        if ($result) {
            ...
            header("refresh:5;url=aforgotpassword.php");
...
<body>
    ...
    <div class="container-fluid" style="background-color: #F4ABAA; max-width: 100%; height:auto;">
        <div class="row justify-content-center align-items-center">
            <img src="../Images/CourierOTP.svg" class="col-md-4 img-fluid" alt="" style="margin: 100px 0px 0px 0px;">
            <form name="myform" action="" method="POST" class="col-md-4 myform" style="margin: 30px 0px 0px 0px;">
                ...
                <div class="d-grid gap-2 inputs">
                    <input class="btn btn-success" type="submit" name="cforgot_otp" value="Change My Password"
        ...
        <div class=" row">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path fill="#ffffff" fill-opacity="1" d="M0,128L17.1,106.7C34.3,85,69,43,103,69.3C137.1,
                    ...
                    32,583,32,617,32C651.4,32,686,32,720,37.3C754.3,
                    43,789,53,823,90.7C857.1,128,891,192,926,192C960,
                    192,994,128,1029,133.3C1062.9,139,1097,213,1131,
                    202.7C1165.7,192,1200,96,1234,58.7C1268.6,21,1303,
                    43,1337,42.7C1371.4,43,1406,21,1423,10.7L1440,
                    0L1440,320L1422.9,320C1405.7,320,1371,320,1337,
                    320C1302.9,320,1269,320,1234,320C1200,320,1166,320,
                    1131,320C1097.1,320,1063,320,1029,320C994.3,320,960,
                    320,926,320C891.4,320,857,320,823,320C788.6,320,754,
                    320,720,320C685.7,320,651,320,617,320C582.9,320,549,
                    320,514,320C480,320,446,320,411,320C377.1,320,343,320,
                    309,320C274.3,320,240,320,206,320C171.4,320,137,320,
                    103,320C68.6,320,34,320,17,320L0,320Z">
                </path>
            </svg>
        </div>
    </div>
