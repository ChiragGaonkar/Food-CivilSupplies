...
if (isset($_POST['areg_submit'])) {
    ...
    if ($apassword === $aconfirm_password) {
        ...
        if (!mysqli_num_rows($result) > 0) {
            ...
            $reason = 'register';
            sendUserOtp($_SESSION['aemail'], $_SESSION['otp'], $_SESSION['afname'], $_SESSION['alname'], $reason);
            header('location:aotpreg.php');
        } else {
...
<body>
    ...
    <div class="container-fluid" style="background-color: #8AA899; max-width: 100%; height:auto;">
        <div class="row justify-content-center align-items-center">
            <img src="../Images/RegisterAdmin.svg" class="col-md-4 img-fluid" alt="" style="margin: 100px 0px 0px 0px;">
