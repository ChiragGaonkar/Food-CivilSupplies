...
if (isset($_POST['clogin_submit'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<div class='alert alert-danger alert-dismissible fade show' role='alert'
            style='max-width: 70%; position: absolute; top: 10%;' >
            Courier Id/Password may be Incorrect! Try Again.
            <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
            </div>";
    }
}
            ...
            <form action="courierboydetails.php" name="myform" method="POST" class="col-md-4 myform" style="margin: 50px 0px 0px 0px;"
                ...
                <div class="form-group row">
                    <div class="input-group inputs" style="width: auto;">
                        ...
                        <input type="text" class="form-control" name="CID" autofocus required>
                    </div>
                    <div class="input-group inputs" style="width: auto;">
                ...
                <div class="d-grid gap-2 inputs">
                    <input class="btn btn-success" type="submit" name="clogin_submit" value="Log-In"
                        style="background-color: #FA2742; border:#FA2742">
                </div>
                <h6 class="text-center inputs">or</h6>
                <h6 class="text-center inputs">
                    <a href="cregister.php" style="color: black; text-decoration: none;">Not a User? Register Now </a>
                    <a href="cforgotpassword.php" style="color: black; text-decoration: none;">| Forgot Password</a>
                </h6>
            </form>
